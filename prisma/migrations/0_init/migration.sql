...
-- AddForeignKey
ALTER TABLE "document" ADD CONSTRAINT "document_content_manager_id_fkey" FOREIGN KEY ("content_manager_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
